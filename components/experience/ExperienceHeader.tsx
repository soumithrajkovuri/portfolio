    ...
    <div className="flex flex-col lg:flex-row justify-between gap-10">
      ...
      <div>
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-5 py-2"
        >
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-slate-700 bg-slate-950/60 px-5 py-4">
